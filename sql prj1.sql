...
-- Started on 2025-05-02 17:18:49
...
-- Name: books1; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.books1 (
...
ALTER TABLE public.books1 OWNER TO postgres;

--
-- TOC entry 217 (class 1259 OID 16487)
-- Name: books1_book_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.books1_book_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.books1_book_id_seq OWNER TO postgres;

--
-- TOC entry 4872 (class 0 OID 0)
-- Dependencies: 217
-- Name: books1_book_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.books1_book_id_seq OWNED BY public.books1.book_id;
...
-- Name: books1 book_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.books1 ALTER COLUMN book_id SET DEFAULT nextval('public.books1_book_id_seq'::regclass);


--
-- TOC entry 4706 (class 2604 OID 16498)
...
--
-- TOC entry 4707 (class 2604 OID 16505)
...
--
-- TOC entry 4862 (class 0 OID 16488)
-- Dependencies: 218
-- Data for Name: books1; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.books1 (book_id, title, author, genre, published_year, price, stock) FROM stdin;
...
--
-- TOC entry 4864 (class 0 OID 16495)
-- Dependencies: 220
...
--
-- TOC entry 4866 (class 0 OID 16502)
-- Dependencies: 222
...
-- Dependencies: 217
-- Name: books1_book_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.books1_book_id_seq', 1, false);
...
-- Name: books1 books1_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.books1
    ADD CONSTRAINT books1_pkey PRIMARY KEY (book_id);
...
--
-- TOC entry 4714 (class 2606 OID 16513)
-- Name: orders orders_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books1(book_id);


--
-- TOC entry 4715 (class 2606 OID 16508)
...
-- Completed on 2025-05-02 17:18:50
